...
<%
	String functionName = "点播媒体分类维护"; //功能名称
...
<script type="text/javascript">  
        ...
        {        	
			...
			$grid = $("#maingrid").ligerGrid({
                ...
                columns: [
	                ...
	                { display: '点播媒体分类背景', name: 'image_bg', width: 150, 
	                	render:function(rowdata,rowindex)
			 	    	{
							return "<img src='data:image/png;base64,"+rowdata.image_bg+"' onclick=\"bigImg(this,'"+rowdata.type_name+"')\" width='150' height='50'/>";
			 	    	}
	                },
	                { display: '排序', name: 'order_no', id:'order_no', align: 'left', width: 80 },	
	                { display: '所属机构编号', name: 'institution', width: 150 },
	                { display: '关联应用', name: 'component', width: 150 },
			...
			$form = $("#mainform").ligerForm({
	        	...
	        	fields:[	//表单栏位	        	    
	        		...
	        		{ display: "点播媒体分类背景",name:"image_bg",type:"popup",validate:{required:false},
		        		editor: {
	        				onButtonClick: selectImageBg
	        			}
	        		},
	        		...
	        		{ display: "关联应用",name:"component",type:"text",validate:{required:false}}
	        	],
        ...
        function toolbarAction(item)
        {
        	action = item.icon;
        	if (action == "add"){
        		$form.setData({type_id:'',server_type:'',type_name:'',ip:'',url_prefix:'',image:'',image_sel:'',image_bg:'',order_no:'',institution:'',component:''});
        		$form.setEnabled(['type_id','type_name','super_id','image','image_sel','image_bg','order_no','institution','component'],true);
        		...
        		$form.setData(select);
        		$form.setEnabled(['type_name','super_id','image','image_sel','image_bg','order_no','institution','component'],true);
        		...
        		$form.setData(select);
        		$form.setEnabled(['type_id','type_name','super_id','image','image_sel','image_bg','order_no','institution','component'],false);        		
        	}
      ...
      //打开图片上传框
        function selectImageBg(){
        	$("#ImgPreview")[0].src="";
        	$("#upload")[0].value="";
        	imageID = 'image_bg';
        	$imageDialog = $.ligerDialog.open({height: 600,width: 800,target: $("#Imgupload")});
        }
