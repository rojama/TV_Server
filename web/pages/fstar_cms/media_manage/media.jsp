...
<script type="text/javascript">  
        ...
        function toolbarAction(item)
        {
        	...
        	action = item.icon;
        	if (action == "add"){
        		$form.setData({media_id:'自动获取',media_name:'',media_describe:'',type_id:type_id,image:'',length:'0',total_series:'1',order_no:'0',director:'',actor:'',score:'0.00'});
        		$form.setEnabled(['media_id','media_name','media_describe','type_id','image','length','total_series','order_no','director','actor','score'],true);
        		...
        		$form.setData(select);
        		$form.setEnabled(['media_id','media_name','media_describe','type_id','image','length','total_series','order_no','director','actor','score'],false);        		
        	}else if (action == "url"){
